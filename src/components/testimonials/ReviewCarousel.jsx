...
const ReviewCarousel = () => {
	...
	return (
		<div className="cozy-flex cozy-flex-col cozy-items-center cozy-gap-16 sm:cozy-flex-row">
			<div className="cozy-flex cozy-flex-col cozy-items-center cozy-justify-center cozy-gap-3 cozy-self-stretch cozy-p-3 cozy-px-3">
				...
				/>
				<h3 className="font-font-graphik-semibold cozy-text-xl cozy-text-heading-3 cozy-text-branding-primary-500">
					CozyCot
				</h3>
			</div>
